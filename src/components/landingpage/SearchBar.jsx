			...
			<div className="container mx-auto flex w-full  max-sm:px-1 relative p-1">
				...
				>
					...
					<input
						...
						className="pl-2 ml-1 max-sm:ml-2 w-[200px] pr-2 tracking-wider focus:invalid:bg-gray-50/10 focus:ring-0 border-none text-black font-semibold text-base py-1 max-sm:py-0 max-sm:w-2/3 max-sm:px-2 rounded-md flex-1 outline-none bg-transparent max-sm:placeholder:text-[11px] placeholder:text-gray-500 placeholder:w-[100%] "
					/>
